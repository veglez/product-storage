...
class ProductServices {
    ...
    static async updateOneByFilter(filter: Partial<ProductSchema>, data: Partial<ProductSchema>) {
        return Product.findOneAndUpdate(filter, data, {new: true })
    }

    static async updateManyByFilter(filter: Partial<ProductSchema>, data: Partial<ProductSchema>) {
    ...
    static async deleteManyByFilter(filter: Partial<ProductSchema>): Promise<TypegooseDeleteModelMethodRespond> {
